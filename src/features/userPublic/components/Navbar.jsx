        ...
        <div className='hidden md:flex items-center py-2 gap-2 w-full justify-between'>
          ...
          <div className='flex flex-row items-start w-full py-2 gap-1'>
            <div className='p-2 flex items-center justify-center '>
              <Link to={'/public/'} className={`text-lm-text font-ws text-sm lg:text-[16px] ${active == "dashboard" ? 'font-semibold' : 'font-normal'}`}>Dashboard</Link>
            </div>
            <div className='p-2 flex items-center justify-center '>
              <Link to={'/public/like'} className={`text-lm-text font-ws text-sm lg:text-[16px] ${active == "like" ? 'font-semibold' : 'font-normal'}`}>Disukai</Link>
            </div>
            <div className='p-2 flex items-center justify-center '>
              <Link to={'/public/save'} className={`text-lm-text font-ws text-sm lg:text-[16px] ${active == "save" ? 'font-semibold' : 'font-normal'}`}>Disimpan</Link>
            </div>
          </div>
