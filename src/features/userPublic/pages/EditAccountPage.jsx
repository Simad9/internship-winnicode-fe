...
import { getUserByUsername, editAkun } from '../api/userPublicAPI'
          ...
          <div className='flex flex-col w-full gap-3 md:gap-3'>
            ...
            <div className='flex flex-col md:flex-row gap-5 items-start'>
              ...
              <div className='flex flex-col gap-1 items-center justify-center w-full md:w-8/12 lg:w-5/12 md:mt-10 lg:mt-5'>
                <img src={file ? URL.createObjectURL(file) : user.profile_picture} alt="" className='size-40 lg:size-50 rounded-md' />
