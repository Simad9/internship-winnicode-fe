    ...
    <div className='flex flex-col gap-5 mb-5'>
      <section className='flex flex-col w-full bg-lm-bg px-[30px] md:px-[40px] lg:px-[60px] gap-3'>
        ...
        <div className='flex flex-col w-full gap-2 mt-3'>
          ...
          <div className='flex flex-col md:flex-row gap-3'>
            ...
            <div className='w-full md:w-8/12'>
              ...
              <input
                ...
                id="req-kategori"
                name="req-kategori"
                class="bg-lm-primary border-1 border-abut-text text-lm-text  text-sm font-mw rounded-lg focus:ring-dm-primary focus:border-dm-primary focus:text-lm-text block w-full p-2.5"
          ...
          {/* Judul */}
          <div>
            <label for="judul" class="block mb-1 text-sm font-medium text-lm-text font-ws">Judul</label>
            <input
              type="text"
              id="judul"
              name="judul"
          ...
          {/* Konten */}
          <div>
            <label for="konten" class="block mb-1 text-sm font-medium text-lm-text font-ws">Isi Berita</label>
            <div>
              <div class="w-full mb-4 border border-abu-text rounded-lg bg-lm-primary">
                ...
                <div class="p-1 bg-white rounded-b-lg">
                  <textarea id="editor" rows="8" class="w-full ps-1 text-sm text-lm-text bg-lm-primary" placeholder="Tulis Berita disini" required ></textarea>
                </div>
              </div>
